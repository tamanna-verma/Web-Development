...
let sourceText=fs.readFileSync(source,"utf-8");                             //reading the file 
let time1_2=Date.now();                                                     //time taken to read the file

console.log(sourceText);                                                    //Printing the source text
...
console.log("Tak 2 started at "+time2_1%100000);
...
console.log("Toatl time taken by task 1 and task 2 is "+time2_2-time1_1);           // printing the total time
